...
export const TRANSLATIONS = {
  EN: {
    ...
    hero_title: "Daily Weather Forecast Update News",
  ...
  KG: {
    ...
    nav_news: "Жаңылыктар",
    nav_map: "Карта",
    nav_pictures: "Сүрөттөр",
    nav_contact: "Байланыш",
    hero_subtitle: "Аба ырайы жана божомол",
    hero_title: "Күнүмдүк аба ырайы маалыматы",
    ...
    contact_btn: "Билдирүүнү жөнөтүү",
    map_title: "Кыргызстандын интерактивдүү картасы",
    map_desc: "Бишкек, Ош, Жалал-Абад, Каракол, Токмок, Өзгөн, Кара-Балта, Балыкчы, Нарын жана Талас шаарларынын картасы.",
    // Weather Conditions
    cond_sunny: "Ачык",
  ...
  RU: {
    ...
    nav_news: "Новости",
    nav_map: "Карта",
    nav_pictures: "Фотографии",
    nav_contact: "Контакты",
    hero_subtitle: "Погода и прогноз",
    hero_title: "Ежедневный прогноз погоды и новости",
    ...
    map_title: "Интерактивная карта погоды Кыргызстана",
    map_desc: "Интерактивная карта с показателями температуры для Бишкека, Оша, Джалал-Абада, Каракола, Токмока, Узгена, Кара-Балты, Балыкчы, Нарына и Таласа.",
    // Weather Conditions
    cond_sunny: "Солнечно",
